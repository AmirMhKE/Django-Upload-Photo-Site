...
from .views import (DashboardStatisticsView, DashBoardView, DeletePostView,
                    EditPostView, PostCreateView, StatisticsView,
                    UserAboutView, UserDeleteView, UserSettingsView)
